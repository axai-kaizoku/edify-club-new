...
const Footer = () => {
  return (
    <div className="w-full bg-[#efefef] items-center justify-center h-full mt-16 overflow-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between h-ful w-full pt-4 lg:pt-6 pb-8 px-4">
          ...
          <div className="text-[#999] flex flex-col md:flex-row-reverse gap-8">
            <div className="flex flex-col gap-2 text-center md:text-left">
              ...
              <a href="mailto:support@edify.club" className="font-gilroySemiBold text-xs lg:text-sm md:p-0 pt-4 xl:text-base hover:underline">
                support@edify.club
              </a>
              <a href="tel:+917470873515" className="font-gilroySemiBold text-xs lg:text-sm xl:text-base hover:underline cursor-pointer">
                +91 7470873515
              </a>
            </div>
            ...
            <div className="md:flex flex-col hidden gap-2">
              ...
              <a href="/terms-of-service" className="font-gilroySemiBold text-xs lg:text-sm xl:text-base cursor-pointer hover:underline">
                Terms of service
              </a>
              <a
                href={"/shipping-policy"}
                className="font-gilroySemiBold text-xs lg:text-sm xl:text-base cursor-pointer hover:underline"
              >
                Shipping Policy
              </a>
              <a
