  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="flex flex-col justify-between rounded-lg h-[85%] w-[24%] cursor-pointer"
          onClick={() => {
            router.push("/all-products")
          }}
        >
          <div className="flex flex-row relative items-center rounded-lg h-[47%] w-[100%] hover:bg-[#F9F9F9] border border-[#E3E3E3]">
