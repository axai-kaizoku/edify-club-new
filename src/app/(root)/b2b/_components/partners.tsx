const Partners = ({ heading }: { heading: string }) => {
  return (
    <section className="flex flex-col sm:gap-11 max-sm:mb-16 sm:py-4 h-full">
      <h1 className="text-center font-orange text-2xl text-nowrap lg:text-3xl xl:text-4xl mb-10">
        {heading}
      </h1>
      <div className="items-center  justify-between hidden sm:flex lg:px-6 h-full">
        <img
          src="/media/b2b/metafin_logo.png"
          alt="metaFin"
          className="lg:w-auto sm:w-24 w-[38px] h-[38px] object-contain"
          loading="lazy"
        />
        <img
          src="/media/b2b/joyspoon.png"
          alt="joyspoon"
          className="lg:w-auto sm:w-24  w-[35px] h-[45px] object-contain"
          loading="lazy"
        />
        <img
          src="/media/b2b/urban_vault.png"
          alt="urban_vault"
          className="xl:w-[100px] xl:h-[90px] lg:w-[130px] lg:h-[70px] sm:w-24 md:w-[110px]  w-[90px] h-[90px] object-contain"
          loading="lazy"
        />
        <img
