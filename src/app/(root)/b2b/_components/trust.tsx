    ...
    <>
      <section className=" w-full flex justify-center items-center flex-col sm:hidden max-sm:mt-20 max-sm:mb-20">
        ...
        <div className="text-center flex flex-col gap-5">
          ...
          <div className=" gap-6 p-6 bg-[url(/media/b2b/custom.png)] rounded-lg bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center lg:w-64">
      ...
      <section className="hidden relative text-center sm:flex justify-center items-center h-[80vh] my-32">
        ...
        <div className=" gap-3 w-36 lg:w-64 top-[5%] lg:top-0 right-[36%] absolute p-3 lg:p-4 bg-[url(/media/b2b/on-site_repair.png)] rounded-lg bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center">
        ...
        <div className=" gap-3 text-center w-[142px] lg:w-64 bottom-[8%] lg:bottom-0 absolute p-4 text-white bg-[url(/media/b2b/quality_assurance.png)] rounded-lg bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center">
          <h1 className="font-orange text-xl lg:text-2xl ">
            {" "}
            Quality
            <br /> Assurance
        ...
        <div className=" gap-3 text-center top-[15%] lg:top-[10%] right-0 w-32 lg:w-64 absolute p-3 lg:p-4  bg-[url(/media/b2b/support.png)] rounded-lg bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center">
          <h1 className="font-orange text-xl lg:text-2xl ">
            24/7 <br /> Support
          </h1>
          <p className="font-gilroySemiBold text-xs lg:text-lg">
        ...
        <div className=" gap-3 text-center w-40 lg:w-64 absolute p-3 lg:p-4 top-[45%] left-0 bg-[url(/media/b2b/sustainable.png)] rounded-lg bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center">
          <h1 className="font-orange text-xl lg:text-2xl ">
